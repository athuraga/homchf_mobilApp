...
import 'package:homchf/model/apply_promocode_model.dart';
...
import 'package:homchf/screens/payment_method_screen.dart';
...
class _MyCartScreenState extends State<MyCartScreen> {
  ...
  double subtotalForBottomAddressChange = 0.0;
...
/*          if (allRows[i]['pro_customization'] == '') {
  ...
  showSelectAddressdialog() {
    ...
    // subtotalForBottomAddressChange = subTotal;
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return StatefulBuilder(
                                    ...
                                    itemBuilder:
                                      ...
                                      onTap: () {
                                        addressSetState(() {
                                          ...
                                          // subTotal = subtotalForBottomAddressChange;
                                          setState(() {});
                                        });
                                      },
                                      child: Column(
    ...
    try {
      ...
      if (response.success!) {
        ...
        if (strOrderSettingDeliveryChargeType == 'order_amount') {
          ...
          print('distance :  ${distanceKm.toString()}');
